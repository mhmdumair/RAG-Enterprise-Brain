...
class DocumentRecord:
    ...
    def to_mongo(self) -> dict[str, Any]:
        d = asdict(self)
        d["_id"] = self.document_id   # use document_id as MongoDB _id
        return d
...
class ResultRecord:
    ...
    Fields:
        query_hash    — SHA-256 of the query string (for caching lookups)
        query         — original query string
        spans         — list of verified AnswerSpan objects
        rake_used     — True if the RAKE fallback was triggered
